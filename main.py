...
app = FastAPI(dependencies=[Depends(RateLimiter(times=10, seconds=3))])
...
@app.get("/check")
async def check_ip(ip: str, contact: str, flags: str):
    url = f"https://check.getipintel.net/check.php?ip={ip}&contact={contact}&flags={flags}"
